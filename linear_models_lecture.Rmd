...
### Doing cross-validation by hand:
```{r}
nonlin_df = 
  tibble(
    id = 1:100,
...
training vs. testing datasets: see how well the red dots predict the black dots2
```{r}
...
Cross Validation: ALways pick the model that will do better on the testing dataset
```{r}
